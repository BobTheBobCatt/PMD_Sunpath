...
MISSION_GEN.DUNGEON_DIFFICULTY[""] = "E"--missions shouldn't be given for relic forest 
MISSION_GEN.DUNGEON_DIFFICULTY[""] = "D"
MISSION_GEN.DUNGEON_DIFFICULTY[""] = "C"
MISSION_GEN.DUNGEON_DIFFICULTY[""] = "B"
...
function DungeonJobList:DrawMenu()
  ...
  local message = ""
  if count == 0 then 
	--player only Dusty Dune
    if SV.ChapterProgression.Chapter == 1 and self.dungeon == 'dusty_dune' and not SV.Chapter1.PlayerCompletedDune then
